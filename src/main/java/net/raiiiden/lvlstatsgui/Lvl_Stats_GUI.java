package net.raiiiden.lvlstatsgui;
...
@Mod(Lvl_Stats_GUI.MOD_ID)
public class Lvl_Stats_GUI {
    public static final String MOD_ID = "lvlstatsgui";
    public static final Logger LOGGER = LogUtils.getLogger();

    public Lvl_Stats_GUI() {
        ...
        PlayerStatsModMenus.REGISTRY.register(bus);
    }
